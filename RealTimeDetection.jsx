  ...
  render() {
    return (
      <div className="greenWaveBox">
        ...
        <div id="lineContainer" className="lineWrapper" style={{ position: 'absolute', bottom: 0, left: 0, width: '100%', height: '100%' }}>
          {/* <svg width="1000px" height="350px" viewBox="0 0 1000 350"> */}
            {/* {
                ...
                <div className="xAxisBox" style={{ width: this.Ws * item + 'px', left: '0px' }} key={'x' + index}>
                  <div style={{ position: 'relative' }}>
                    ...
                    <div className="realTimeDetectionBox" style={{ display: 'flex', position: 'absolute', top: '-345px', right: '-13px', height: '345px', width: '13px', overflow: 'hidden'}}>
                      <div id={'detection' + index} className="detectionBoxs" style={{ position: 'absolute', bottom: '0', width: '100%', fontSize: '12px', transform: 'rotate(180deg)', transition: 'all ease .2s' }}>
                    ...
                    <div className="realTimeDetectionBox2" style={{ display: 'flex', position: 'absolute', top: '-345px', right: '-35px', height: '345px', width: '13px', overflow: 'hidden'}}>
                      <div id={'detection2' + index} className="detectionBoxs2" style={{ position: 'absolute', bottom: '0', width: '100%', fontSize: '12px', transform: 'rotate(180deg)', transition: 'all ease .2s' }}>
